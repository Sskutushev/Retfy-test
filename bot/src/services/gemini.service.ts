...
export class GeminiService {
    ...
    /**
     * Analyzes a user's communication style based on their messages.
     * @param messages 
     * @param userInfo 
     * @returns 
     */
    async analyzeUser(messages: Message[], userInfo: User): Promise<string> {
        const prompt = this.constructPrompt(messages, userInfo);
    ...
    private constructPrompt(messages: Message[], userInfo: User): string {
